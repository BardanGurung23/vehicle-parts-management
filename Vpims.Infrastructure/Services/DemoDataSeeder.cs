    ...
    PasswordHasher<User> passwordHasher)
{
        ...
        CancellationToken cancellationToken)
    {
        Part[] parts =
        [
            new() { PartNumber = "BRK-PAD-001", PartName = "Premium Brake Pad Set", PartCategoryId = categoryMap["Brakes"], VendorId = vendors["Valley Brake Center"].VendorId, UnitPrice = 3200m, CostPrice = 2500m, StockQuantity = 8, ReorderLevel = 10, Description = "Front brake pad set for sedan platforms." },
            new() { PartNumber = "ENG-FLT-001", PartName = "Engine Oil Filter", PartCategoryId = categoryMap["Engine"], VendorId = vendors["Everest Auto Supplies"].VendorId, UnitPrice = 850m, CostPrice = 540m, StockQuantity = 32, ReorderLevel = 12, Description = "Standard engine oil filter." },
            new() { PartNumber = "ELC-BAT-001", PartName = "12V Maintenance-Free Battery", PartCategoryId = categoryMap["Electrical"], VendorId = vendors["Himal Parts House"].VendorId, UnitPrice = 9800m, CostPrice = 7600m, StockQuantity = 5, ReorderLevel = 6, Description = "Long-life 12V battery for passenger vehicles." },
            new() { PartNumber = "SUS-SHK-001", PartName = "Rear Shock Absorber", PartCategoryId = categoryMap["Suspension"], VendorId = vendors["Everest Auto Supplies"].VendorId, UnitPrice = 4100m, CostPrice = 3000m, StockQuantity = 14, ReorderLevel = 8, Description = "Rear suspension shock absorber." },
            new() { PartNumber = "FLD-CLT-001", PartName = "Engine Coolant", PartCategoryId = categoryMap["Fluids"], VendorId = vendors["Himal Parts House"].VendorId, UnitPrice = 1200m, CostPrice = 780m, StockQuantity = 18, ReorderLevel = 10, Description = "Pre-mixed coolant for routine service." }
        ];
